...
import overloadAllTheOperators from './assets/overload-all-the-operators.png';
...
<ArticlePicture src={overloadAllTheOperators} alt={'"Overload all the operators" meme'} />
As tempting as it is to overload every single operator in C++—and yes, it is possible—we must
remember that, like most things in life, "great power comes with great responsibility." Operator
overloading must be used sparingly and only when _completely_ and _absolutely_ necessary.

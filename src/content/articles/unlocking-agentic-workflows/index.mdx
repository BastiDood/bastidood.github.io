...
![visualization of 0-40% being the "smart zone", 40-85% being the "dumb zone", and 85-100% being the "compact zone"](./assets/context-window-zones.png)
...
![visualization of a full conversation context window with a system prompt and its tool calls](./assets/full-conversation-context.png)

![visualization of a compacted conversation context window with a system prompt and its tool calls](./assets/compacted-conversation-context.png)
...
![visualization of an overloaded conversation context window with a system prompt and its tool calls](./assets/overloaded-conversation-context.png)
...
![three explorer agents taking up around ~60k tokens each](./assets/parallel-explorer-context.png)
...
![visualization of a naive map-reduce workflow with a main orchestrator and its sub-agents dumping their context into the main context window](./assets/naive-map-reduce.png)
...
![visualization of a parallel map-reduce workflow with a main orchestrator and its sub-agents dumping their context into their own file outputs](./assets/file-backed-map-reduce.png)

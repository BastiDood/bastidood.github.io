...
featuredAt: '2026-04-19T15:22:44Z'
cover:
    src: './cover.png'
...
import contextWindowZones from './assets/context-window-zones.png';
import fullConversationContext from './assets/full-conversation-context.png';
import compactedConversationContext from './assets/compacted-conversation-context.png';
import overloadedConversationContext from './assets/overloaded-conversation-context.png';
import parallelExplorerContext from './assets/parallel-explorer-context.png';
import naiveMapReduce from './assets/naive-map-reduce.png';
import fileBackedMapReduce from './assets/file-backed-map-reduce.png';
...
<ArticlePicture
	src={contextWindowZones}
	alt={
		'visualization of 0-40% being the "smart zone", 40-85% being the "dumb zone", and 85-100% being the "compact zone"'
	}
/>
...
<ArticlePicture
	src={fullConversationContext}
	alt="visualization of a full conversation context window with a system prompt and its tool calls"
/>

<ArticlePicture
	src={compactedConversationContext}
	alt="visualization of a compacted conversation context window with a system prompt and its tool calls"
/>
...
<ArticlePicture
	src={overloadedConversationContext}
	alt="visualization of an overloaded conversation context window with a system prompt and its tool calls"
/>
...
<ArticlePicture
	src={parallelExplorerContext}
	alt="three explorer agents taking up around ~60k tokens each"
/>
...
<ArticlePicture
	src={naiveMapReduce}
	alt="visualization of a naive map-reduce workflow with a main orchestrator and its sub-agents dumping their context into the main context window"
/>
...
<ArticlePicture
	src={fileBackedMapReduce}
	alt="visualization of a parallel map-reduce workflow with a main orchestrator and its sub-agents dumping their context into their own file outputs"
/>

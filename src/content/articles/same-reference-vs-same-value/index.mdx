...
import separateStringInstances from './assets/separate-string-instances.png';
import sharedStringInstance from './assets/shared-string-instance.png';
...
<ArticlePicture
	src={separateStringInstances}
	alt="Each variable points to their own instance of the string."
/>
...
<ArticlePicture src={sharedStringInstance} alt="Both variables point to the same string." />

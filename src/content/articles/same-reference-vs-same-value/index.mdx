...
![Each variable points to their own instance of the string.](./assets/separate-string-instances.png)
...
![Both variables point to the same string.](./assets/shared-string-instance.png)

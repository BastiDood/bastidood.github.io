...
I recently read [an article from @rachelsoderberg about what it means to write good variable names](https://dev.to/rachelsoderberg/writing-good-method-variable-names-47il). In her article, she discusses the many strategies and considerations involved in writing descriptive variable names.

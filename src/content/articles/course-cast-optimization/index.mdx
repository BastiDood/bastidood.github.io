...
featuredAt: '2025-08-21T15:43:06Z'
...
import utilityConfiguration from './assets/utility-configuration.png';
import simulationResults from './assets/simulation-results.png';

<ArticlePicture src={dashboard} alt="CourseCast Dashboard Home" />
...
<ArticlePicture src={utilityConfiguration} alt="CourseCast Course Utility Configuration" />
...
<ArticlePicture src={simulationResults} alt="CourseCast Simulation Results" />

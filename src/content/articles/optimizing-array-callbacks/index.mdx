...
import nodeResults from './assets/node-results.png';
import chromeResults from './assets/chrome-results.png';
import nodeResultsLimited from './assets/node-results-limited.png';
import chromeResultsLimited from './assets/chrome-results-limited.png';
import nodeResultsExtended from './assets/node-results-extended.png';
import chromeResultsExtended from './assets/chrome-results-extended.png';
...
<ArticlePicture src={nodeResults} alt="Node.js Runtime Results" />
<ArticlePicture src={chromeResults} alt="Google Chrome Browser Environment Results" />
...
<ArticlePicture src={nodeResultsLimited} alt="Node.js Runtime Results (Limited)" />
<ArticlePicture
	src={chromeResultsLimited}
	alt="Google Chrome Browser Environment Results (Limited)"
/>
...
<ArticlePicture src={nodeResultsExtended} alt="Extended Results for Node.js Runtime" />
<ArticlePicture
	src={chromeResultsExtended}
	alt="Extended Results for Google Chrome Browser Environment"
/>

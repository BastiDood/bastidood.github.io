...
updatedAt: 2026-09-22T07:03:04Z
...
I've tried the opposite of this workflow, where I had the agent incrementally "implement in phases" (a la [Matt Pocock](https://www.aihero.dev/workshops/ai-coding-crash-course)). This never really worked for me because I typically ended up with a patchwork of seemingly unrelated changes to review that didn't work end-to-end until the final integration phase. I had to suspend disbelief and blindly trust that the agent was going in the right direction. In contrast, a fuller implementation out of the box made it easier to preview the end-to-end correctness.

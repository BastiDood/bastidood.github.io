...
![An overview of the tree-like traversal of coding agents in a codebase](./assets/coding-agent-overview.png)
...
![Visualization of a horizontally sliced codebase require bloated reads and exploration in the codebase](./assets/monolithic-files-bloat-context.png)
...
![Visualization of how narrow slices in a vertically sliced architecture yield more surgical reads, edits, and incremental changes](./assets/vertical-slices-and-surgical-edits.png)

    ...
    <article id="projects" class="space-y-8">
      ...
      <section id="drap" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          students, the selection of draftees by faculty members, the assignment of lab memberships
          per draft round, the randomization of draftees during lottery rounds, and the dispatch of
          email notifications throughout the entire draft process.
        </p>
        <p>
          Previously, this process would have spanned weeks' worth of email exchanges between the
          department administrators and the faculty members. With the DRAP automation in place, the
          August 2024 Draft wrapped up within the week. The August 2024 Draft also happened to be
          the <em>largest draft in DCS history:</em>
      ...
      <section id="hotspotter" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <ol>
          <li>
            ...
            index, which enables Hotspotter to aggregate data at varying resolutions, is especially useful
            for optimizing download times by pruning viewport-occluded data points from the map visualization.
          </li>
          <li>
          ...
          <li>
            ...
            built-in sensors in modern smartphones to collect and upload data on nearby Wi-Fi access
            points and cellular network signal strengths. Under the hood, the mobile application is
            a front-end
      ...
      <section id="dapped-out" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          <a target="_blank" href="https://solana.com/">Solana</a> blockchain. The objective of the game
          is simple: try to press a button as close to a targeted marker as possible. The closest contestant
          to the target wins the greatest share in the contested pot.
        </p>
        <p>
          ...
          user-generated token instead. The creator has the privilege of minting new supply as well
          as transferring tokens to other wallets.
        </p>
        <p>
          Users may now join the existing contest by staking some tokens into the shared pot. They
          now try their luck in timing the meter as closely as possible. At any point in the future,
          the contest host may close the contest to finally distribute the winnings in proportion to
          the accuracy of each contestant. Past contests are archived for future audits.
        </p>
        <p>
      ...
      <section id="botoken" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          polling system for decentralized autonomous organizations. Polls, proposals, motions, and referendums
          are published in the
          <a target="_blank" href="https://ethereum.org/">Ethereum</a> blockchain for permanence and
          transparency. Voting power is then quantified as fungible tokens that the organization
          controls and regulates. Members within the organization thus "spend" their voting power
          (i.e., fungible tokens) on polls to express their consent or dissent on organizational
          processes. The
      ...
      <section id="acda" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          designed to generate crash data reports and statistics to help policymakers and officials
          promote road safety in the Philippines. This solution combines data from various sources,
          including police reports, hospital records, and other data repositories collected by the
          <b
        ...
        <p>
          Under the hood, <abbr title="Aggregated Crash Data Analysis">ACDA</abbr> is an installable
          full-stack
          <a
            target="_blank"
            href="https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps"
      ...
      <section id="up-csi" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          is a student-oriented organization aimed towards the enhancement of student learning from the
          ...
          with real-world projects. As part of my 2023-2024 term as the Director for Engineering, I was
          tasked to lead the development and deployment of the organization's official website—a project
          that had previously been postponed over the years.
        </p>
        <p>
          ...
          <a target="_blank" href="https://kit.svelte.dev/">SvelteKit</a> and developed in the open by
          UP CSI's members.
        </p>
        <div class="md:flex md:gap-4">
      ...
      <section id="drippy" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          water company, etc.) may access a time-series representation of water consumption through
          a dashboard interface on the Web. The project was ultimately a
        ...
        <p>
          ...
          dashboard, a customer/user may remotely release the valve. Inversely, they may also
          remotely close the valve (under normal operation) should the need arise. Thus, the IoT
        ...
        <div class="flex justify-around gap-4">
          ...
          <div>
            <img class="m-0 max-h-96" src={drippyDashboard} alt="Drippy dashboard" loading="lazy" />
          </div>
        </div>
        <p>
      ...
      <section id="palai" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          <a href="https://parceljs.org/">Parcel</a> build tool for asset bundling, packaging, and optimization.
          The PWA allows users to upload their own images of rice plants for classification.
        </p>
        <div class="flex gap-4">
          <div>
            <img
      ...
      <section id="soundrave" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          music released by a user's followed artists on Spotify. At the time, the news feed was missing
          from Spotify's features. The app aimed to fill in this hole.
        </p>
        <p>
          The <dfn><abbr title="User Interface">UI</abbr></dfn> is primarily rendered by the server
          via the
      ...
      <section id="quizzo" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          <a
            ...
            >Discord bot</a
          >
          written in <a href="https://www.rust-lang.org/">Rust</a> for hosting limited-time quizzes.
          With Discord's built-in
          <a
          ...
          large-scale quizzes with many users. When the quiz timer expires, Quizzo notifies everyone
          in the channel which users answered the quiz correctly. The pioneer use of message
          components differentiates Chrozone from the other bots in the market which use clunky
          reaction-based polling mechanisms.
        </p>
      ...
      <section id="multicast" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          <a href="https://tokio.rs/">Tokio</a>-powered server that listens for UDP messages over a
          specified multicast address. The same multicast channel is also used for sending new
      ...
      <section id="option-block" class="bg-card max-w-none scroll-mt-20 rounded-xl p-8 shadow-xl">
        ...
        <p>
          ...
          is an open-source Rust package that provides a basic direct address look-up table, where empty
          slots are tracked by a single bit mask. Although it is rather simple, this is a fundamental
        ...
        >
          ...
          interfaces, this
          <strong>saves 672 bytes of RAM usage</strong>, while I also observed minor improvement in
          code size—<a href="https://github.com/dlkj/usbd-human-interface-device"
